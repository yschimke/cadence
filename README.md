# Cadence — design artifacts

Importable sticker-sheet for **`androidx.compose.material3:material3`**, rendered from the committed
`@Preview` catalog in [`yschimke/cadence`](https://github.com/yschimke/cadence). This branch is a
**generated delivery artifact** — browse it in the page below, or pull it into
Figma / Stitch / Claude Design.

## 🔎 Browse the catalog

**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/cadence/blob/design-artifacts/cadence/index.html)**
...
**[▶ Open the SVG↔PNG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/cadence/blob/design-artifacts/cadence/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/cadence/)**

The same rendered components, served live by `compose-preview serve --catalogs cadence` —
...
| Renderer | compose-preview 1.63.0 |
...
| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/cadence/blob/design-artifacts/cadence/index.html) |
| `compare.html` | SVG↔PNG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/cadence/blob/design-artifacts/cadence/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/cadence/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
...
Generated by the [`Design Artifacts`](https://github.com/yschimke/cadence/actions/workflows/design-artifacts.yml)
