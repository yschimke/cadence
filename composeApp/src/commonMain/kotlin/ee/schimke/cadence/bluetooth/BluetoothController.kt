...
enum class AdvancedCommandCategory { Audio, Power, Voice, Pairing, Diagnostics, Firmware }

/**
 * Catalogue of vendor commands surfaced in the advanced menu. Most map to RCSP
 * opcodes documented in research/rcsp.md; until the RFCOMM transport ships,
 * unsupported commands return a placeholder result.
 */
