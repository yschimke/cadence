...
interface RefreshOrchestrator {
    ...
    /**
     * Refreshes the given profile by mirroring its sources into the local
     * staging directory. Returns when finished, or throws on failure (so
     * WorkManager can apply its retry policy).
     */
