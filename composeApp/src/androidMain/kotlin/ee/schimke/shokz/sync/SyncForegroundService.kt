...
class SyncForegroundService : Service() {
    ...
    private fun appGraph(): AndroidAppGraph {
        val app = applicationContext as? ShokzApplication
    ...
    companion object {
        private const val CHANNEL_ID = "shokz_sync"
        private const val NOTIFICATION_ID = 0xC0DE
        const val EXTRA_TARGET_DEVICE_ID = "ee.schimke.shokz.sync.TARGET_DEVICE_ID"
